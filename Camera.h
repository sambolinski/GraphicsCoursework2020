...
public:
    ...
    int GetViewType() const { return m_view_type; };             //gets the camera view type; 0 is third person, 1 is birds eye, 2 is freeview -added
    void SetViewType(int view_type) { m_view_type = view_type; } //sets the view type; 0 is third person, 1 is birds eye, 2 is freeview -added
    void CycleViewType();
    void SetUpVector(glm::vec3 upVector) {m_upVector = upVector;} //added to set the upvector
